...
export const ACHIEVEMENTS_CATALOG: Achievements = {
  skill: [
    ...
    {
      id: "ace_counter_lifetime",
      title: "Ace Count",
      description: "Track your lifetime aces.",
      category: "skill",
      categoryId: "aces",
      subcategory: "aces",
      resetPolicy: "never",
  ...
  social: [
    ...
    {
      id: "cardmates_same_person_150",
      title: "Disc Golf Dynasty",
      description: "Play 150 rounds with the same person",
      category: "social",
      categoryId: "cardmates",
      subcategory: "cardmates",
      resetPolicy: "never",
    ...
    {
      id: "cardmates_50_people",
      title: "Card Magnet",
      description: "Record rounds with 50 different people",
      category: "social",
      categoryId: "cardmates",
      subcategory: "cardmates",
      resetPolicy: "never",
    ...
    {
      id: "cardmates_group_10",
      title: "League Familiar",
      description: "Play with the same group of 4+ people 10 times",
      category: "social",
      categoryId: "cardmates",
      subcategory: "cardmates",
      resetPolicy: "never",
    ...
    // COMPETITION & EVENTS (tiered category card)
    {
      id: "ce_unsanctioned_first",
      title: "First Unsanctioned Event",
      description: "Play your first non-sanctioned event (club league, flip dubs, etc.)",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_sanctioned_first",
      title: "First Sanctioned Event",
      description: "Play your first sanctioned event (sanctioned league or tournament)",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_5_sanctioned_tournaments",
      title: "5 Sanctioned Tournaments",
      description: "Play in 5 sanctioned tournaments",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_10_sanctioned_tournaments",
      title: "10 Sanctioned Tournaments",
      description: "Play in 10 sanctioned tournaments",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_25_sanctioned_tournaments",
      title: "25 Sanctioned Tournaments",
      description: "Play in 25 sanctioned tournaments",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_tournament_out_of_state",
      title: "Out-of-State Tournament",
      description: "Play in a tournament in a different state than where you reside",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_50_sanctioned_rounds",
      title: "50 Sanctioned Rounds",
      description: "Play 50 sanctioned rounds",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_100_sanctioned_rounds",
      title: "100 Sanctioned Rounds",
      description: "Play 100 sanctioned rounds",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_tournament_podium",
      title: "Tournament Podium",
      description: "Finish on the podium at a sanctioned tournament",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
    ...
    {
      id: "ce_tournament_win",
      title: "Tournament Champion",
      description: "Win your division at a sanctioned tournament",
      category: "social",
      categoryId: "competition-events",
      subcategory: "competitionEvents",
      resetPolicy: "never",
  ...
  collection: [
    ...
    },
    {
      ...
      title: "State Hopper",
      description: "Play a round in 2 different US states (or equivalent regions)",
      category: "collection",
      categoryId: "course-explorer",
      subcategory: "courseExplorer",
      resetPolicy: "never",
    ...
    {
      id: "log_rounds_5_states",
      title: "Road Trippin'",
      description: "Play a round in 5 different states (or equivalent regions).",
      category: "collection",
      categoryId: "course-explorer",
      subcategory: "courseExplorer",
      resetPolicy: "never",
    ...
    },
    {
      id: "play_15_states",
      title: "National Tour",
      description: "Play a round in 15 different states (or equivalent regions).",
      category: "collection",
      categoryId: "course-explorer",
      subcategory: "courseExplorer",
      resetPolicy: "never",
    ...
    // ROUND MILESTONES
    {
      id: "round_counter_lifetime",
      title: "Round Count",
      description: "Track your lifetime rounds played.",
      category: "collection",
    ...
    },
    {
      ...
      description: "Play at least once a week for 52 consecutive weeks",
      category: "collection",
      categoryId: "round-milestones",
      subcategory: "roundMilestones",
      resetPolicy: "never",
...
const CARDMATES_TIER_IDS: Record<number, string[]> = {
  ...
  1: ["social-6", "social-10", "social-11", "social_branching_out", "social_rounds_with_15"],
  2: ["social-12", "social-13", "social_rounds_with_25"],
  3: ["cardmates_same_person_150", "cardmates_50_people", "cardmates_group_10"],
};
...
const COURSE_EXPLORER_TIER_IDS: Record<number, string[]> = {
  ...
  3: ["play_15_states", "course_top5_all_country", "course_5_countries"],
};

const COMPETITION_EVENTS_TIER_IDS: Record<number, string[]> = {
  0: ["ce_unsanctioned_first", "ce_sanctioned_first"],
  1: [
    "social-0",
    "social-22",
    "social-23",
  ...
  2: [
    "ce_5_sanctioned_tournaments",
    "ce_10_sanctioned_tournaments",
    "ce_25_sanctioned_tournaments",
    "ce_tournament_out_of_state",
  ],
  3: [
    "ce_50_sanctioned_rounds",
    "ce_100_sanctioned_rounds",
    "ce_tournament_podium",
    "ce_tournament_win",
  ],
};
...
const ROUND_MILESTONES_TIER_IDS: Record<number, string[]> = {
  ...
  3: ["round_counter_lifetime", "round_1000th", "round_weekly_streak_52"],
};
  ...
  "cardmates": {
    ...
    tiers: [
      ...
      },
      {
        ...
        tierKey: "expert",
        themeToken: "expert",
        achievements: pickDefs(CARDMATES_TIER_IDS[3]),
      },
    ],
  },
  "good-samaritan": {
    ...
    tiers: [
      {
        ...
        tierKey: "beginner",
        themeToken: "beginner",
        achievements: pickDefs(COMPETITION_EVENTS_TIER_IDS[0]),
      },
      {
        tierIndex: 1,
        tierKey: "intermediate",
        themeToken: "intermediate",
        achievements: pickDefs(COMPETITION_EVENTS_TIER_IDS[1]),
      },
      {
        tierIndex: 2,
        tierKey: "advanced",
        themeToken: "advanced",
        achievements: pickDefs(COMPETITION_EVENTS_TIER_IDS[2]),
      },
      {
        tierIndex: 3,
        tierKey: "expert",
        themeToken: "expert",
        achievements: pickDefs(COMPETITION_EVENTS_TIER_IDS[3]),
      },
    ],
  },
  "disc-collection": {
